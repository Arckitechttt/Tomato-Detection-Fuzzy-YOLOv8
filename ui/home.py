...
"}")
        ...
        self.VersionLabel.setStyleSheet(u"font: 900 10pt \"Segoe UI\";\n"
"color: rgba(255, 255, 255, 199);")
...
"}")
        ...
        self.explain_title.setStyleSheet(u"font: 700 10pt \"Segoe UI\";")
...
"")
        ...
        self.char_label.setMinimumSize(QSize(0, 22))
        self.char_label.setMaximumSize(QSize(16777215, 22))
        font1 = QFont()
        font1.setPointSize(20)
        font1.setBold(True)
        self.char_label.setFont(font1)
        self.char_label.setStyleSheet(u"")
...
"border-radius: 15px;\n"
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 #3b3b3b,  stop:1 #4f4f4f);\n"
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.pre_video.setFont(font2)
        self.pre_video.setStyleSheet(u"color: black;\n"
"font: 700 16pt \"Segoe UI\";\n"
"background-color: rgb(237, 237, 237);\n"
"border:2px solid rgb(196, 196, 196);\n"
"border-radius:15px")
        self.pre_video.setAlignment(Qt.AlignCenter)
        self.pre_video.setWordWrap(False)
        self.pre_video.setIndent(0)
        ...
        self.res_video.setFont(font2)
        self.res_video.setStyleSheet(u"color: black;\n"
"font: 700 16pt \"Segoe UI\";\n"
"background-color: rgb(237, 237, 237);\n"
"border:2px solid rgb(196, 196, 196);\n"
"border-radius:15px")
        self.res_video.setAlignment(Qt.AlignCenter)
        self.res_video.setWordWrap(False)
        self.res_video.setIndent(0)
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"Ver: 1.0.1", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"TomaTect", None))
        self.ToggleBotton.setText(QCoreApplication.translate("MainWindow", u"Hide", None))
        self.src_file_button.setText(QCoreApplication.translate("MainWindow", u"Upload", None))
        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"TomaTect\u00a9", None))
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"TomaTect:  A Graphical User Interface (GUI) for Fresh / Rotten Tomato Detection using Fuzzy YOLOv8", None))
        self.settings_button.setText("")
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"Tomato Detection", None))
        ...
        self.pre_video.setText(QCoreApplication.translate("MainWindow", u"Uploaded Image", None))
        self.res_video.setText(QCoreApplication.translate("MainWindow", u"Detection Result", None))
        ...
        self.status_bar.setText(QCoreApplication.translate("MainWindow", u"Hello, welcome to TomaTect app!", None))
    # retranslateUi
